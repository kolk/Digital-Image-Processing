...
\includegraphics [width=4in]{sinTrans_01.eps}
...
\includegraphics [width=4in]{sinTrans_02.eps}
...
\end{verbatim}
        ...
        \color{lightgray} \begin{verbatim}Warning: Image is too big to fit on screen; displaying at 33% 
\end{verbatim} \color{black}
    
\includegraphics [width=4in]{sinTrans_03.eps}
